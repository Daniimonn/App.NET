...
namespace PeliculasTarea1 {
    ...
    public partial class VideoclubDataSet : global::System.Data.DataSet {
        ...
        public partial class PeliculasDataTable : global::System.Data.TypedTableBase<PeliculasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PeliculasRow AddPeliculasRow(string Nombre, string Director, string Sinopsis, string Genero) {
...
namespace PeliculasTarea1.VideoclubDataSetTableAdapters {
    ...
    public partial class PeliculasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Peliculas] WHERE (([id_Pelicula] = @Original_id_Pelicula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Director = 1 AND [Director] IS NULL) OR ([Director] = @Original_Director)) AND ((@IsNull_Genero = 1 AND [Genero] IS NULL) OR ([Genero] = @Original_Genero)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Peliculas] ([Nombre], [Director], [Sinopsis], [Genero]) VALUES" +
                " (@Nombre, @Director, @Sinopsis, @Genero);\r\nSELECT id_Pelicula, Nombre, Director" +
                ", Sinopsis, Genero FROM Peliculas WHERE (id_Pelicula = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Peliculas] SET [Nombre] = @Nombre, [Director] = @Director, [Sinopsis] = @Sinopsis, [Genero] = @Genero WHERE (([id_Pelicula] = @Original_id_Pelicula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Director = 1 AND [Director] IS NULL) OR ([Director] = @Original_Director)) AND ((@IsNull_Genero = 1 AND [Genero] IS NULL) OR ([Genero] = @Original_Genero)));
SELECT id_Pelicula, Nombre, Director, Sinopsis, Genero FROM Peliculas WHERE (id_Pelicula = @id_Pelicula)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PeliculasTarea1.Properties.Settings.Default.VideoclubConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_Pelicula, Nombre, Director, Sinopsis, Genero FROM dbo.Peliculas";
        ...
        public virtual int Delete(int Original_id_Pelicula, string Original_Nombre, string Original_Director, string Original_Genero) {
        ...
        public virtual int Insert(string Nombre, string Director, string Sinopsis, string Genero) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Director, string Sinopsis, string Genero, int Original_id_Pelicula, string Original_Nombre, string Original_Director, string Original_Genero, int id_Pelicula) {
            if ((Nombre == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(id_Pelicula));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Director, string Sinopsis, string Genero, int Original_id_Pelicula, string Original_Nombre, string Original_Director, string Original_Genero) {
            return this.Update(Nombre, Director, Sinopsis, Genero, Original_id_Pelicula, Original_Nombre, Original_Director, Original_Genero, Original_id_Pelicula);
        }
    }
    ...
    public partial class QueriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).Connection = new global::System.Data.SqlClient.SqlConnection(global::PeliculasTarea1.Properties.Settings.Default.VideoclubConnectionString);
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).CommandText = "dbo.proInsert";
            ...
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@director", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@sinopsis", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@genero", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int proInsert(string nombre, string director, string sinopsis, string genero) {
            ...
            if ((sinopsis == null)) {
                ...
                command.Parameters[3].Value = ((string)(sinopsis));
            }
            if ((genero == null)) {
